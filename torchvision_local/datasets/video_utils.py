...
import torch
from torchvision_local.io import _probe_video_from_file, _read_video_from_file, read_video, read_video_timestamps
...
class VideoClips:
    ...
    def get_clip(self, idx: int) -> Tuple[torch.Tensor, torch.Tensor, Dict[str, Any], int]:
        ...
        from torchvision_local import get_video_backend

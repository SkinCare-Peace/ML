...
from torchvision_local.models._meta import _IMAGENET_CATEGORIES
from torchvision_local.models._utils import _ovewrite_named_param, handle_legacy_interface
from torchvision_local.ops.misc import Conv2dNormActivation, SqueezeExcitation
from torchvision_local.ops.stochastic_depth import StochasticDepth
from torchvision_local.transforms._presets import ImageClassification, InterpolationMode

...
from torchvision_local.models import inception as inception_module
from torchvision_local.models.inception import Inception_V3_Weights, InceptionOutputs

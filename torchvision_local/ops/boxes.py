...
from torchvision_local.extension import _assert_has_ops
...
def batched_nms(
    ...
    if boxes.numel() > (4000 if boxes.device.type == "cpu" else 20000) and not torchvision_local._is_tracing():
...
def clip_boxes_to_image(boxes: Tensor, size: Tuple[int, int]) -> Tensor:
    ...
    if torchvision_local._is_tracing():

...
from torchvision_local.prototype.datasets.utils import Dataset, HttpResource, OnlineResource
from torchvision_local.prototype.datasets.utils._internal import hint_sharding, hint_shuffling, INFINITE_BUFFER_SIZE
from torchvision_local.prototype.tv_tensors import Label
from torchvision_local.prototype.utils._internal import fromfile
from torchvision_local.tv_tensors import Image

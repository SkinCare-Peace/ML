...
from torchvision_local.datasets import VOCDetection
from torchvision_local.prototype.datasets.utils import Dataset, EncodedImage, HttpResource, OnlineResource
from torchvision_local.prototype.datasets.utils._internal import (
    getitem,
    hint_sharding,
    hint_shuffling,
...
from torchvision_local.tv_tensors import BoundingBoxes

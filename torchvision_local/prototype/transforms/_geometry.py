...
from torchvision_local.prototype.tv_tensors import Label, OneHotLabel
from torchvision_local.transforms.v2 import functional as F, Transform
from torchvision_local.transforms.v2._utils import (
    _FillType,
    _get_fill,
    _setup_fill_arg,
    _setup_size,
